package battle.controllers.simpleGA;

import battle.controllers.mcts.MacroAction;
...
public class GAController extends Controller {
    ...
    public battle.controllers.heuristic.graph.Graph m_graph;       //Graph for pathfinding.
