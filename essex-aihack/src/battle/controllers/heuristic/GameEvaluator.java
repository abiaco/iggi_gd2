package battle.controllers.heuristic;

import battle.controllers.heuristic.graph.Node;
import battle.controllers.heuristic.graph.SightPath;
import battle.controllers.heuristic.graph.Graph;
...
public class GameEvaluator
{
    ...
    private double score(Game a_game)
    {
        ...
        {
            battle.controllers.heuristic.graph.Path p = getPathToWaypoint(a_game,closestW);
    ...
    public double score2(Game a_gameState)
    {
        ...
        }else
        {
            ...
            battle.controllers.heuristic.graph.Path pathToFirst = getPathToWaypoint(a_gameState,w0);
            battle.controllers.heuristic.graph.Path pathToSecond = null, pathFirstToSecond = null;
    ...
    public double getDistanceScore(battle.controllers.heuristic.graph.Path a_p)
    {
